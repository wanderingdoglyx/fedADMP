...
#part_n_noniid=[0.4133333333333336, 0.7334999999999999, 0.8161666666666666, 0.913, 0.9048333333333334, 0.9308333333333333, 0.9443333333333334, 0.9463333333333335, 0.9455, 0.9458333333333333]
...
part_b_noniid=[0.7600000000000001, 0.798, 0.87, 0.914, 0.9340000000000001, 0.9584999999999999, 0.99, 0.988, 0.9855, 0.993]
...
part_sf_noniid=[0.653, 0.7645000000000001, 0.8059999999999999, 0.886, 0.9325, 0.948, 0.9545, 0.9740000000000001, 0.9790000000000001, 0.9890000000000001]
...
sfte=(st/1200)*np.array(batch_ratio)+0.5*np.array([0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457])
...
sfct=sfte*sf_converage_epoach*cut_ratio*batch_epoch
...
sfe=np.array(sf_converage_epoach)*cut_ratio*batch_epoch
print(list(ne),'ne')
print(list(be),'be')
print(list(ke),'ke')
print(list(se),'se')
