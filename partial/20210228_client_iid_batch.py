...
Labels = ['New York', 'Beijing', 'Krong Siem Reap', 'Seattle','San Fransisco']
Colors = ['y', 'b', 'g', 'r','c']
...
sf_converage_epoach=np.array(sf_converage_epoach)*batch_epoch
...
sfte=(st/1200)*np.array(batch_ratio)+np.array([0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457,0.0818457])
...
sfct=sfte*sf_converage_epoach*cut_ratio
