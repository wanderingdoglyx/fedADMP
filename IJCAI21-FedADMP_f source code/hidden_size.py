...
csf1=[ 14.388225 ,36.54,53.057 ,  73.28,   74.7 , 74.5877]

x1=[32,50,64,100,128,256]


fig, (ax1) = plt.subplots(1, 1, figsize=(30, 13))
############data_time_interveral

    ############Beijing


Ln2 = ax1.plot(x1,cb1 , Colors[1], label=Labels[0], marker='8',linewidth=4,markersize=12)
Ln3 = ax1.plot(x1,ck1 , Colors[2], label=Labels[1],marker='p', linewidth=4,markersize=12)
Ln4 = ax1.plot(x1,cs1 , Colors[3], label=Labels[2],marker='P', linewidth=4,markersize=12)
Ln1 = ax1.plot(x1,cn1 , Colors[0], label=Labels[3], marker='s',linewidth=4,markersize=12)
Ln5 = ax1.plot(x1,csf1 , Colors[4], label=Labels[4],marker='*', linewidth=4,markersize=12)
